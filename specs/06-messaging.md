...
- [x] Delete message (author or admin) → replaced with deleted placeholder
- [x] Reply to message → quoted context shown above reply
- [x] Infinite scroll: scrolling to top loads older messages without losing scroll position
- [x] 10 000 message room remains usable (virtual list or windowing)
- [x] Content over 3072 chars rejected with clear error
- [x] Non-member cannot POST to room (403)
- [x] Personal dialog: banned participant cannot send new messages (403)
